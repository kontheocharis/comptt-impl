...
appBDs l env ~v bds = case (env, bds) of
  ([], []) -> v
  (env :> t, bds :> Bound q) -> sApp l (appBDs l env v bds) t SMeta q Expl
...
quoteO l = \case
  ...
  OPi x q i r a b -> Pi x SObj q i (quoteORep r) (quoteO l a) (quoteO (l + 1) b)
